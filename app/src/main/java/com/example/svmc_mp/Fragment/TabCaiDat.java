...
import com.example.svmc_mp.Fragment.TabCaiDat_ThanhPhanCon.ChonNgonNgu;
...
public class TabCaiDat extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //chọn ngôn ngữ:
//        btnDoiNgonNgu = (Button) view.findViewById(R.id.id_btn_doi_ngonngu);
//        btnDoiNgonNgu.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startActivity(new Intent(getContext(), ChonNgonNgu.class));
//            }
//        });
